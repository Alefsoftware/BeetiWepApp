            ...
            <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr class="pt-30 ml-5">
                                    ...
                                    <td class="product-des product-name">
                                        <h6 class="mb-5"><a class="product-name mb-10 text-heading" href="#">{{@$row->product->title}}</a></h6>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width:{{(@$row->product->AvgRate/5)*100 ?? 0}}%">
                                                </div>
                                            </div>
                                            <span class="font-small ml-5 text-muted"> ({{@$row->product->AvgRate ?? 0}})</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-center detail-info" data-title="Stock">
                                        <div class="detail-extralink mr-15 col-md-3">
                                            {{-- <div class="detail-qty border radius"> --}}
                                                ...
                                                {{-- <span class="qty-val">{{$row->count}}</span> --}}
                                                {{-- <a href="#" class="qty-up"><i class="fi-rs-angle-small-up"></i></a> --}}

                                                    {{-- <input type="hidden" name='cart_id[{{$key}}]' value="{{$row->id}}"> --}}
                                                     <input type="number" name="count[{{$row->id}}]" value="{{$row->count}}">
                ...
                <div class="col-lg-4">
                    <div class="border p-md-4 cart-totals ml-30">
                        ...
                        <a href="{{route('order.index')}}" class="btn mb-20 w-100">Proceed To CheckOut<i class="fi-rs-sign-out ml-15"></i></a>
                    </div>
                </div>
            </div>
        </div>
