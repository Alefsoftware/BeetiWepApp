        ...
        <div class="container pt-15 pb-20">
            ...
            <div class="footer-link-widget widget-install-app col wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                ...
                <div class="download-app">
                    <a href="#" class="hover-up mb-sm-2 mb-lg-0"><img class="active" src="{{asset('front/assets/imgs/theme/app-store.jpg')}}" alt="" /></a>
...
<!-- Template  JS -->
<script src="{{asset('front/assets/js/main.js?v=5.6')}}"></script>
<script src="{{asset('front/assets/js/shop.js?v=5.6')}}"></script>
</body>
