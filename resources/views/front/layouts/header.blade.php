    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="deal" style="background-image: url('{{asset('front/assets/imgs/banner/popup-1.png')}}')">
                    <div class="deal-top">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                        <div class="detail-gallery">
                            ...
                            <div class="slider-nav-thumbnails">
                                ...
                                <div><img src="{{asset('front/assets/imgs/shop/thumbnail-7.jpg')}}" alt="product image" /></div>
                    ...
                    <div class="header-info header-info-right">
                        <ul>
                            ...
                            <li>
                                ...
                                <ul class="language-dropdown">
                                    <li>
                                        <a href="#"><img src="{{asset('front/assets/imgs/theme/flag-fr.png')}}" alt="" />Français</a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="{{asset('front/assets/imgs/theme/flag-dt.png')}}" alt="" />Deutsch</a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="{{asset('front/assets/imgs/theme/flag-ru.png')}}" alt="" />Pусский</a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                    ...
                    <div class="header-action-right">
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <a href="{{route('account.index')}}"><span class="lable ml-0">Account</span></a>
                        ...
                        <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                            <div class="d-flex categori-dropdown-inner">
                                <ul>
                                    ...
                                    <li>
                                        <a href="shop-grid-right.html"> <img src="{{asset('front/assets/imgs/theme/icons/category-3.svg')}}" alt="" />Pet Foods & Toy</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"> <img src="{{asset('front/assets/imgs/theme/icons/category-4.svg')}}" alt="" />Baking material</a>
                                    </li>
                                    <li>
                                    ...
                                    <ul class="mega-menu">
                                        ...
                                        <li class="sub-mega-menu sub-mega-menu-width-34">
                                            <div class="menu-banner-wrap">
                                                <a href="shop-product-right.html"><img src="{{asset('front/assets/imgs/banner/banner-menu.png')}}" alt="Nest" /></a>
                        ...
                        <div class="header-action-icon-2">
                            ...
                            <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                <ul>
                                    ...
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="shop-product-right.html"><img alt="Nest" src="{{asset('front/assets/imgs/shop/thumbnail-4.jpg')}}" /></a>
                                        </div>
                                        <div class="shopping-cart-title">
