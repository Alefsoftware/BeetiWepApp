...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <a href='{{route("blog.create")}}' class="btn btn-primary shadow-md mr-2">{{__('Add New Blog')}}</a>
                ...
                <div class="box p-5 zoom-in">
                    <div class="flex items-center">
                        <div class="w-2/4 flex-none">
                            <div style="min-width: 250px;" class="text-lg font-medium truncate">{{__('Total Blogs')}}</div>
    ...
    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
        <table class="table table-report -mt-2">
            ...
            <tr class="intro-x">
                ...
                <td>
                    <a href="" class="font-medium">{{$row->title}}</a>
                ...
                <td>
                    <a href="" class="font-medium whitespace">{{$row->des}}</a>
                ...
                <td class="w-40">
                    <div class="form-check form-switch w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0">
                        <form id='status{{$row->id}}' action='{{route('blog.changeStatus',$row->id)}}' method='post'>
                            @csrf
                ...
                <td class="table-report__action w-56">
                    <div class="flex justify-center items-center">
                        <a class="flex items-center mr-3" href="{{route('blog.edit',$row->id)}}"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
        ...
        <div class="modal-content">
            <div class="modal-body p-0">
                ...
                <div class="px-5 pb-8 text-center">
                    ...
                    <form action="{{route('blog.destroy',$row->id)}}" method="post" id='delform' style="display: inline-block">
                        @csrf
                        @method('delete')
