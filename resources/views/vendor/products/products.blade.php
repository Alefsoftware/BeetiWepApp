...
{{--                                            <div class="report-box__indicator bg-success tooltip cursor-pointer" title="33% Higher than last month"> 33% <i data-lucide="chevron-up" class="w-4 h-4 ml-0.5"></i> </div>--}}
            ...
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                ...
                <div class="dropdown">
                    ...
                    <a href='{{route("vendor.products.create")}}' class="btn btn-primary shadow-md mr-2">{{__('Add New Product')}}</a>
            ...
            <form method="get" action="{{url('provider/products')}}">
                @csrf
            ...
            <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-3">
                <div class="box">
                    ...
                    <div class="flex justify-center lg:justify-end items-center p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                        ...
                        <a class="flex items-center mr-3" href="{{url('provider/products/edit/'.$product->id)}}"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                        ...
                        <div class="modal-content">
                            <div class="modal-body p-0">
                                ...
                                <div class="px-5 pb-8 text-center">
                                    ...
                                    <form action="{{URL('provider/products/delete',$product->id)}}" method="post" id='delform' style="display: inline-block">
                                        @csrf
                                        @method('delete')
