...
<div class="intro-y col-span-12 lg:col-span-6 mt-5">
    ...
    <div class="intro-y box">
        <div class="flex flex-col sm:flex-row items-center p-5 border-b border-slate-200/60 dark:border-darkmode-400">
            ...
            <form name="add-blog-post-form" id="add-blog-post-form" method="post" action="{{route('blog.store')}}" enctype="multipart/form-data">
        ...
        <div id="vertical-form" class="p-5">
            <div class="preview">
                ...
                <div class="mt-3">
                    ...
                    <input id="vertical-form-2" type="text" class="form-control"  name="title_ar">
                </div>
                @error('title_ar')
                <div class="error">{{ $message }}</div>
                @enderror
                <div class="mt-3">
                    ...
                    <textarea id="vertical-form-2" class="form-control" name="des"></textarea>
                </div>
                @error('des')
                <div class="error">{{ $message }}</div>
                @enderror
                <div class="mt-3">
                    ...
                    <textarea id="vertical-form-2" class="form-control" name="des_ar"></textarea>
                </div>
                @error('des_ar')
                <div class="error">{{ $message }}</div>
                @enderror
                <div class="mt-3">
                    ...
                    <textarea id="vertical-form-2" class="form-control" name="summary"></textarea>
                </div>
                @error('summary')
                <div class="error">{{ $message }}</div>
                @enderror
                <div class="mt-3">
                    ...
                    <textarea id="vertical-form-2" class="form-control" name="summary_ar"></textarea>
                </div>
                @error('summary_ar')
                <div class="error">{{ $message }}</div>
                @enderror
