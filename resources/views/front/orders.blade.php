                    ...
                    <div class="table-responsive order_table checkout">
                        <table class="table no-border">
                            <tbody>
                                @foreach($cart as $row)
                                <tr>
                                    <td class="image product-thumbnail"><img src="{{@$row->product->image}}" alt="{{@$row->product->title}}" onerror="this.onerror=null;this.src='{{ asset('default_product.png') }}';"></td>
                                    <td>
                                        <h6 class="w-160 mb-5"><a href="{{route('product.details',@$row->product->slug)}}" class="text-heading">{{@$row->product->title}}</a></h6></span>
